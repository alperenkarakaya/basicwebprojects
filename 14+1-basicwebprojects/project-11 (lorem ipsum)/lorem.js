...
const amountOfParagraphs=document.querySelector("#amount-of-paragraphs")
const generator=document.querySelector("#generator")
const paragraphsDiv=document.querySelector("#paragraphs")

generator.addEventListener("click",function(){
    let paragraphs=amountOfParagraphs.value;
    let paragraphsDivText="";
    for(let i=1; i<=paragraphs;i++){
        let number=Math.floor(Math.random()*9+1);
        paragraphsDivText+=`<p> uwu ${text[number-1]}</p>`;
        console.log(paragraphsDivText);
    }
    paragraphsDiv.innerHTML=paragraphsDivText;
})
